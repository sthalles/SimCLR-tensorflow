...
from utils import _dot_simililarity_dim1 as sim_func_dim1, _dot_simililarity_dim2 as sim_func_dim2, \
    get_negative_mask, read_images, normalize

# aug_image = distort_image_with_randaugment(tf.ones((32,32,3), dtype=tf.float32), num_layers=2, magnitude=5)
#
